...
function (_Component) {
  ...
  function Filter(props) {
    ...
    _this.handleClickClear = _this.handleClickClear.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }
  ...
  _createClass(Filter, [{
    ...
    value: function render() {
      var _this$props = this.props,
          clearFilterText = _this$props.clearFilterText,
      ...
      }), clearable && value && !disabled ? _react.default.createElement("span", {
